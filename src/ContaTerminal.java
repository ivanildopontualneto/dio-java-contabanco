...
public class ContaTerminal {
	public static void main(String[] args) {
		...
		System.out.println("Olá " + nomeCliente + ", obrigado por criar sua conta no PontualBank. Sua agência é a de número " + agencia + " e sua conta é a de número " + conta + ", com saldo inicial de R$" + saldo + ".");
	}
}